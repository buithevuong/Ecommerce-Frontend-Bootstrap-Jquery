...
axios.get('http://localhost:8081/api/cart/'+getCookie("user"))
.then(function (response) {
	
/*-----------------------------------------get item----------------------------------------*/
  axios({
    method: 'post',
    url: 'http://localhost:8081/api/item/allitembycart',
    data: {
...
$(".btn-checkOut").click(function(e) {
  ...
  axios({
    ...
    data: {
      cart_id : 1,
      payment_id : $('.btn-payment').val(),
      shipment_id : $(".btn-shipment").val(),
      status : 1
